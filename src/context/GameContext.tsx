...
interface GameContextValue {
    ...
    isConnected: boolean;
    createRoom: (roomName: string, maxPlayers: number) => Promise<GameRoomResponse>;
    joinRoom: (roomId: string, playerId: string) => Promise<GameRoomResponse>;
...
export const GameProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const createRoom = useCallback(
        async (roomName: string, maxPlayers: number): Promise<GameRoomResponse> => {
    ...
    const joinRoom = useCallback(
        async (roomId: string, pid: string): Promise<GameRoomResponse> => {
